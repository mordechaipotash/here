...
const oAuth2Client = new OAuth2Client(process.env.GOOGLE_CLIENT_ID, process.env.GOOGLE_CLIENT_SECRET, 'urn:ietf:wg:oauth:2.0:oob');
oAuth2Client.setCredentials({
    refresh_token: process.env.GOOGLE_REFRESH_TOKEN
});
const gmail = google.gmail({ version: 'v1', auth: oAuth2Client });
// Initialize Supabase client
const supabase = createClient('https://yawnfaxeamfxketynfdt.supabase.co', process.env.SUPABASE_SERVICE_ROLE_KEY);
